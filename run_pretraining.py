...
flags.DEFINE_string(
    ...
    "gs://tpu-storage/data_balanced/val/*",
...
def input_fn_builder(input_files,
    ...
    def input_fn(params):
        ...
        weights = tf.constant([2.07500868, 1.03715683, 1.93284648, 1.21630542, 1.13895236,
                               1.35432071, 1.09689163, 1.6204935, 1.16378624, 1.18903464,
                               1., 1.56280185, 1.35888667, 1.28946654, 1.37520308,
                               1.20126476, 1.1674391, 1.22790734, 1.10949764, 2.07500868,
                               1.49259834, 2.07500868])
